...
from dream.cam_utils import orbit_camera, OrbitCamera
from dream.gs_renderer import Renderer, MiniCam

from dream.grid_put import mipmap_linear_grid_put_2d
from dream.mesh import Mesh, safe_normalize
    ...
    def prepare_train(self):
        ...
        if self.guidance_sd is None and self.enable_sd:
            if self.opt.mvdream:
                ...
                from dream.guidance.mvdream_utils import MVDream
                self.guidance_sd = MVDream(self.device)
                print(f"[INFO] loaded MVDream!")
            else:
                print(f"[INFO] loading SD...")
                from dream.guidance.sd_utils import StableDiffusion
                self.guidance_sd = StableDiffusion(self.device)
                print(f"[INFO] loaded SD!")

        if self.guidance_zero123 is None and self.enable_zero123:
            print(f"[INFO] loading zero123...")
            from dream.guidance.zero123_utils import Zero123
