...
from gaussian_splatting.utils.render_utils import save_img_f32, save_img_u8,transform_poses_pca, focus_point_fn
# from utils.render_utils import save_img_f32, save_img_u8

# def render_from_mesh(mesh,
#                             c2w_list,
#                             H, W, fx, fy, cx, cy,
#                             far=100.0,):
...
#     flags = pyrender.RenderFlags.OFFSCREEN | pyrender.RenderFlags.RGBA | pyrender.RenderFlags.SKIP_CULL_FACES
...
#         color,_ = renderer.render(scene, flags)
...
def post_process_mesh(mesh, cluster_to_keep=1000):
    ...
    """
    import copy
    print("post processing the mesh to have {} clusterscluster_to_keep".format(cluster_to_keep))
...
class GaussianExtractor(object):
    ...
    def extract_mesh_unbounded(self, resolution=1024):
        ...
        from gaussian_splatting.utils.mcube_utils import marching_cubes_with_contraction
